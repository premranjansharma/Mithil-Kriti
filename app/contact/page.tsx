...
export default function ContactPage() {
  ...
  const inputCls = `w-full px-3.5 py-2.5 bg-[#] border border-[#B8922A] rounded-sm
  ...
  return (
    <main
      className="bg-[#f0eaea] text-[#000000] min-h-screen"
      style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif" }}
    >
      <div className="max-w-5xl mx-auto px-6 py-16">

        {/* ── Hero ─────────────────────────────────────────────────────── */}
        <div className="border border-[#B8922A] rounded-sm px-8 py-12 mb-8 relative overflow-hidden">
          {/* gold corner accents */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          {/* FORM */}
          <div className="border border-[#B8922A] rounded-sm p-7">
            <h2
              className="text-[#E8D5A0] text-[17px] mb-6 pb-4 border-b border-[#ddd650]"
              style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 500 }}
            >
              Send Us a Message
            </h2>
          ...
          <div className="border border-[#B8922A] rounded-sm p-7">
            ...
            <div className="flex gap-3 items-start mb-5">
              <div className="w-8 h-8 rounded-sm bg-[#9d7d1d] border border-[#B8922A] flex items-center justify-center shrink-0 text-[#B8922A]">
                <IconLocation />
              </div>
              <div>
                <p className="text-[10px] tracking-[0.18em] uppercase text-[#7f7257] font-medium mb-1">Office</p>
                <p className="text-[13px] text-[#B8922A] leading-relaxed">Darbhanga, Bihar 846004<br />India</p>
              </div>
            </div>

            {/* Email */}
            <div className="flex gap-3 items-start mb-5">
              <div className="w-8 h-8 rounded-sm bg-[#b9b062] border border-[#B8922A] flex items-center justify-center shrink-0 text-[#B8922A]">
                <IconMail />
              </div>
              <div>
            ...
            <div className="flex gap-3 items-start mb-6">
              <div className="w-8 h-8 rounded-sm bg-[#f1f1f0] border border-[#B8922A] flex items-center justify-center shrink-0 text-[#B8922A]">
                <IconPhone />
              </div>
              <div>
        ...
        {/* ── FAQ ──────────────────────────────────────────────────────── */}
        <div className="border border-[#B8922A] rounded-sm p-7 mb-6">
          <h2
            className="text-[#E8D5A0] text-[17px] mb-6 pb-4 border-b border-[#1a1a1a]"
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 500 }}
          >
        ...
        <div className="border border-[#B8922A] rounded-sm px-8 py-8 flex flex-col sm:flex-row
          ...
          <Link
            href="/shop"
            className="shrink-0 px-7 py-3 border border-[#B8922A] text-[#B8922A]
